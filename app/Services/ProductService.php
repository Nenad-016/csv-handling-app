...
public function updateProduct(Product $product, ProductDTO $data): ?Product
{
...
public function exportProductsByCategory(Category $category): string
{
    ...
    fputcsv($file, [
        'ID', 'Product Number', 'Category ID', 'Manufacturer Name', 'UPC',
        'SKU', 'Regular Price', 'Sale Price', 'Description'
    ]);
